<template>
	<view>
		...
		<block v-if="mode == 'number' || mode == 'card'">
			<u-number-keyboard :random="random" @backspace="backspace" @change="change" :mode="mode" :dotEnabled="dotEnabled" :confirmBtn="confirmBtn" :confirmText="confirmText" @confirm="onConfirm"></u-number-keyboard>
		</block>
		<block v-else>
...
<script>
	 ...
	 * @property {Boolean} s 是否开启底部安全区适配（默认false）
	 ...
	 */
	import uNumberKeyboard from '@/components/uview-ui/components/u-number-keyboard/u-number-keyboard.vue'
