            ...
            <view class="item">
                ...
                <u-form :model="formData" ref="dataForm" label-width="320">
                    ...
                    <view v-if="checked">
                        ...
                        <u-form-item label="非法人支行地址" prop="ilLegalPersonBankAddressCode" v-if="formData.ilLegalPersonBankAccountType === 'CORPORATE'">
                            <pick-regions :defaultRegion="formData.ilLegalPersonBankAddressCode" @getRegion="handleGetRegionIlLegal"/>
                        </u-form-item>
                        <u-gap height="60" bg-color="#ffffff"></u-gap>
		...
		methods: {
            ...
            nextPage(formName) {
                ...
                this.$refs[formName].validate((valid) => {
                    console.log(valid);
                    if (valid) {
                        // if(bankCardPic==''||bankAccountType==''||bankAccountBank==''||bankChannelNo==''||bankAccountNo==''||bankAccountName==''){
                        //     uni.showToast({
                        //         duration: 3000,
                        //         icon:'none',
                        //         title: "请填写法人银行卡信息",
